        ...
        {isOpen && (
          ...
          >
            ...
            {messages.length === 1 && !loading && (
              <div className="px-4.5 py-4 border-t border-indigo-50 bg-gradient-to-b from-white to-indigo-50/20 space-y-2.5">
                ...
                <div className="grid gap-2">
                  {(AI_PANEL_LANG[language]?.suggestions || AI_PANEL_LANG.en.suggestions).map((s, i) => {
                    ...
                    const gradients = [
                      "hover:bg-gradient-to-r hover:from-blue-50 hover:to-indigo-50/50 hover:text-indigo-700 hover:border-indigo-200",
                      "hover:bg-gradient-to-r hover:from-emerald-50 hover:to-teal-50/50 hover:text-teal-700 hover:border-teal-200",
                      "hover:bg-gradient-to-r hover:from-amber-50 hover:to-orange-50/50 hover:text-orange-700 hover:border-orange-200",
                      "hover:bg-gradient-to-r hover:from-rose-50 hover:to-pink-50/50 hover:text-pink-700 hover:border-pink-200"
                    ];
                    ...
                    return (
                      <button
                        ...
                        className={`w-full text-left rounded-2xl border border-slate-200/80 bg-white p-3 text-xs font-semibold text-slate-600 transition-all hover:scale-[1.01] hover:-translate-y-0.5 hover:shadow-sm cursor-pointer flex items-center gap-3 active:scale-[0.99] ${grad}`}
                      >
